    ...
    sequentialChannelOperations.push((done) => {
      ...
      vhost.getChannel((err, channel) => {
        ...
        const result = channel
          .consume(config.source, onMessage, config.options)
          .then((response) => {
            console.log({
              msg: 'Subscription.subscribeNow#channel.consume.then',
              data: {
                response,
              }
            })
          ...
          .catch((err) => {
            console.log({
              msg: 'Subscription.subscribeNow#channel.consume.catch',
              data: {
                err,
              }
            })
        ...
        console.log({
          msg: 'Subscription.subscribeNow#channel.consume.result',
          data: {
            result,
          }
        })
